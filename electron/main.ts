...
async function initializeApp() {
  // Set app name to "Cheatos" so userData path uses this name instead of package.json name
  // This must be called BEFORE app.whenReady() and BEFORE any app.getPath() calls
  // IMPORTANT: Must be called before AppState.getInstance() because ScreenshotHelper
  // calls app.getPath("userData") in its constructor
  app.setName("Cheatos")
